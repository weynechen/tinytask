...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void idle_print_task_func(void *arg)
{
    TT_TASK_START;
    printf("idle print task started\n");
    while (1) {
      printf("idle print task\n");
      TT_TASK_DELAY_MS(10000);
    }
...
int main(void)
{
  ...
  printf("short press: led blink once\n");
  printf("long press: led blink five times\n");
